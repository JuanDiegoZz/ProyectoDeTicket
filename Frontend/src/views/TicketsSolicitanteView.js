            ...
            <table class="table table-tecnm table-hover mb-0">
              ...
              <tbody>
                ...
                <tr v-for="t in tickets" :key="t.id">
                  ...
                  <td>
                    <span v-if="t.prioridad === 'Alta'" class="badge-priority-alta"><i class="bi bi-lightning-fill me-1"></i>Alta</span>
                    <span v-else class="badge-priority-normal">Normal</span>
                  </td>
                  <td>
                    <span v-if="t.estado === 'Abierto'" class="badge-status-abierto"><i class="bi bi-hourglass-split me-1"></i>Abierto</span>
                    <span v-else-if="t.estado === 'EnProgreso'" class="badge-status-progreso"><i class="bi bi-gear-fill me-1"></i>En Atención</span>
                    <span v-else-if="t.estado === 'Resuelto'" class="badge-status-resuelto"><i class="bi bi-check2-all me-1"></i>Resuelto</span>
