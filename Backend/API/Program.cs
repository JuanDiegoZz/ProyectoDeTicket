...
// 1. Configurar DbContext (PostgreSQL 18 / SQLite fallback)
...
// 3. Configurar Política de CORS Segura para Frontend Vue 3
builder.Services.AddCors(options =>
{
    options.AddPolicy("FrontendVuePolicy", policy =>
    {
...
// 4. Configurar Autenticación con Cookies para API
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
    .AddCookie(options =>
    {
        options.Cookie.Name = "TecNMTicketsAuthCookie";
...
// 5. Configurar Controladores API con Formateo JSON (CamelCase y Enums como String)
...
// Configurar Pipeline HTTP de la API REST
app.UseStaticFiles();
app.UseRouting();

app.UseCors("FrontendVuePolicy");
